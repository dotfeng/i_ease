...
import com.iecampus.mulpickphotos.BitmapCache.ImageCallback;
...
public class PhotoAlbumListAdapter extends BaseAdapter {
	...
	public PhotoAlbumListAdapter(Activity act, List<PhotoAlbum> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.item_photo_album_list, null);
		...
		PhotoAlbum item = dataList.get(arg0);
