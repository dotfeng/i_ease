...
public class AppUpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		updateNotification.setLatestEventInfo(this, "爱易校园", "0%",
				updatePendingIntent);
		// 发出通知
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_COMPLETE:
				...
				updateNotification.setLatestEventInfo(AppUpdateService.this,
						"爱易校园", "下载完成,点击安装。", updatePendingIntent);
				updateNotificationManager.notify(0, updateNotification);
			...
			while ((readsize = is.read(buffer)) > 0) {
				...
				if ((downloadCount == 0)
					...
					updateNotification.setLatestEventInfo(
							AppUpdateService.this, "正在下载", (int) totalSize
									* 100 / updateTotalSize + "%",
							updatePendingIntent);
